            ...
            if isinstance(event, MessageEvent):
                ...
                if event.message.text.lower() == "foo":
                    ...
                    rpy = [
                        ...
                        ImageSendMessage(
                            original_content_url=cards.image_uris()["png"],
                            preview_image_url=cards.image_uris()["png"],
                        ),
                    ]
                    ...
                    names = fetch_card_name(event.message.text)
                    if names == "":
                        cards = scrython.cards.Named(
                            fuzzy=get_card_name(event.source.user_id)
                        )
